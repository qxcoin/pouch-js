...
test('can create valid address', async () => {
  const wallet = new EthereumWallet('radar blur cabbage chef fix engine embark joy scheme fiction master release', 'mainnet', { provider: 'http://example.com', contracts: {} });
